                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="password" class="form-control" name="password_confirmation" placeholder="Confirm Password" id="password-id-icon">
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-lock"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="output" style="margin-top: 20px ; height: 200px;width: 200px" src="{{asset('uploads/users/default.jpg')}}" />
                                        </div>
                                    </div>
                                    @php
                                        $roles = ['users','category'];
                                                ...
                                                <div class="tab-pane fade show {{$loop->first ? 'active':''}}"
                                                    ...
                                                    @foreach($permissions as $permission)
                                                        <label style="cursor: pointer" class="form-control"><input
                                                                ...
                                                                type="checkbox">{{__('site.'.$permission)}}{{__('site.'.$role)}}
                                                        </label>
                                                    @endforeach
                                                </div>
                                            @endforeach
